...
def encontrar_maior_e_menor(matriz):
    # Inicializar o maior e o menor com o primeiro elemento da matriz
    maior = matriz[0][0]
    menor = matriz[0][0]
...
# Encontrar o maior e o menor valor da matriz
maior_valor, menor_valor = encontrar_maior_e_menor(matriz)
